...
.g{display:grid;grid-template-columns:repeat(3,1fr);gap:18px;padding:18px 40px 40px}
figure{margin:0}img{width:100%;display:block;border-radius:6px}
figcaption{font-weight:800;font-size:22px;padding:10px 2px 0}</style></head><body>
